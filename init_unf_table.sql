CREATE TABLE kart_racing_unf 
    ( 
		...
		booking_status VARCHAR2 (20 CHAR) NOT NULL, 
        booking_created_at DATE NOT NULL, 
        booking_reserved_until DATE, 

		-- Time Slots
        time_slot_id INTEGER NOT NULL, 
        time_slot_start_time VARCHAR2 (5 CHAR) NOT NULL, 
        time_slot_end_time VARCHAR2 (5 CHAR) NOT NULL, 
		...
		track_name VARCHAR2 (50 CHAR) NOT NULL, 
