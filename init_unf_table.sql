CREATE TABLE kart_racing_unf 
    ( 
		...
		customer_first_name VARCHAR (50 CHAR) NOT NULL, 
        customer_last_name VARCHAR (50 CHAR) NOT NULL, 
        customer_email VARCHAR (50 CHAR) NOT NULL, 
		...
		booking_status VARCHAR (20 CHAR) NOT NULL, 
        booking_created_at DATE NOT NULL, 
        booking_reserved_until DATE, 

		-- Time Slots
        time_slot_id INTEGER NOT NULL, 
        time_slot_start_time VARCHAR (5 CHAR) NOT NULL, 
        time_slot_end_time VARCHAR (5 CHAR) NOT NULL, 
		...
		track_name VARCHAR (50 CHAR) NOT NULL, 
